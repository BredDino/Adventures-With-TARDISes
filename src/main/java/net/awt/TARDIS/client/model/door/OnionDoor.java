...
public class OnionDoor extends DoorModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData Door_r1 = OmgitsaUFO.addChild("Door_r1", ModelPartBuilder.create().uv(96, 0).cuboid(-1.0F, -7.0F, -7.0F, 2.0F, 14.0F, 14.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 35.0F, 0.0F, -1.5708F, 0.0F, -1.5708F));
