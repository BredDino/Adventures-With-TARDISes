...
import net.awt.TARDIS.console.variants.JunkGlassVariant2;
import net.minecraft.util.Identifier;
import org.joml.Vector3f;

public class ClientJunkGlassVariant2 extends ClientConsoleVariantSchema {
    ...
    public static final Identifier EMISSION = new Identifier(AdventuresWithTARDISes.MOD_ID, "textures/blockentities/consoles/junkglass_purple_emission.png");

    public ClientJunkGlassVariant2() {
        super(JunkGlassVariant2.REFERENCE, JunkGlassVariant2.REFERENCE);
    }
