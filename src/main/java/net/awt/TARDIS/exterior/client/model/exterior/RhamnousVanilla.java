...
public class RhamnousVanilla extends SimpleExteriorModel {
	...
	public RhamnousVanilla(ModelPart root) {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		.uv(38, 20).cuboid(-8.0F, 24.0F, -24.0F, 16.0F, 0.0F, 32.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
