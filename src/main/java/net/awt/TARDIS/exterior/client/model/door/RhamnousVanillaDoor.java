...
public class RhamnousVanillaDoor extends DoorModel {
	private final ModelPart bone;
	private final ModelPart door;
	public RhamnousVanillaDoor(ModelPart root) {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData door = bone.addChild("door", ModelPartBuilder.create().uv(63, 278).cuboid(0.0F, -32.0F, 0.0F, 16.0F, 32.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
