...
public class policebox_door extends DoorModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData cube_r6 = phone.addChild("cube_r6", ModelPartBuilder.create().uv(77, 48).cuboid(-1.0F, -1.0F, -1.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(-1.5429F, -3.5F, -0.2071F, 0.0F, 0.7854F, 0.0F));

		ModelPartData cube_r7 = phone.addChild("cube_r7", ModelPartBuilder.create().uv(73, 48).cuboid(-1.0F, -1.0F, -1.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(-0.0429F, -3.5F, -0.2071F, 0.0F, 0.7854F, 0.0F));
