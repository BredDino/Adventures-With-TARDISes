...
public class neziko extends SimpleExteriorModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		.uv(58, 0).cuboid(-8.25F, -27.0F, -6.0F, 0.0F, 3.0F, 14.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r9 = bone.addChild("cube_r9", ModelPartBuilder.create().uv(17, 89).cuboid(1.0F, -1.0F, 0.0F, 0.0F, 1.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData door = bone.addChild("door", ModelPartBuilder.create().uv(100, 6).cuboid(-13.0F, -30.0F, -1.0F, 13.0F, 30.0F, 1.0F, new Dilation(0.0F))
