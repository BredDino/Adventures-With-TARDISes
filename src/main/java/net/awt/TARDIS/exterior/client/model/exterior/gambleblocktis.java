...
public class gambleblocktis extends SimpleExteriorModel {
	...
	public gambleblocktis(ModelPart root) {
		this.bone = root.getChild("bone");
		this.door = this.bone.getChild("door");
		this.middle = this.bone.getChild("middle");
		this.trapdoor = this.middle.getChild("trapdoor");
		...
		this.beacon = this.bone.getChild("beacon");
	}
    public gambleblocktis()   {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData door = bone.addChild("door", ModelPartBuilder.create().uv(63, 278).cuboid(0.0F, -8.0F, 0.0F, 16.0F, 32.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(-8.0F, 0.0F, -24.0F));
		...
		ModelPartData trapdoor = middle.addChild("trapdoor", ModelPartBuilder.create().uv(18, 18).cuboid(0.0F, 16.0F, -32.0F, 16.0F, 16.0F, 1.0F, new Dilation(0.0F))
		.uv(18, 18).cuboid(32.0F, 16.0F, -32.0F, 16.0F, 16.0F, 1.0F, new Dilation(0.0F))
		.uv(18, 18).cuboid(0.0F, 16.0F, 17.0F, 16.0F, 16.0F, 1.0F, new Dilation(0.0F))
		.uv(18, 18).cuboid(32.0F, 16.0F, 17.0F, 16.0F, 16.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(-24.0F, -24.0F, 7.0F));

		ModelPartData cube_r1 = trapdoor.addChild("cube_r1", ModelPartBuilder.create().uv(18, 18).cuboid(-16.0F, -18.0F, 0.0F, 16.0F, 16.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(48.0F, 34.0F, -31.0F, 0.0F, 1.5708F, 0.0F));

		ModelPartData cube_r2 = trapdoor.addChild("cube_r2", ModelPartBuilder.create().uv(18, 18).cuboid(-16.0F, -18.0F, 0.0F, 16.0F, 16.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-1.0F, 34.0F, 1.0F, 0.0F, 1.5708F, 0.0F));

		ModelPartData cube_r3 = trapdoor.addChild("cube_r3", ModelPartBuilder.create().uv(18, 18).cuboid(-16.0F, -18.0F, 0.0F, 16.0F, 16.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(48.0F, 34.0F, 1.0F, 0.0F, 1.5708F, 0.0F));

		ModelPartData cube_r4 = trapdoor.addChild("cube_r4", ModelPartBuilder.create().uv(18, 18).cuboid(-16.0F, -18.0F, 0.0F, 16.0F, 16.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-1.0F, 34.0F, -32.0F, 0.0F, 1.5708F, 0.0F));
		...
		.uv(0, 66).cuboid(-24.0F, -21.0F, 24.8F, 48.0F, 10.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -2.0F, 0.0F));

		ModelPartData cube_r5 = sign.addChild("cube_r5", ModelPartBuilder.create().uv(0, 90).cuboid(-26.0F, 0.0F, -1.0F, 48.0F, 10.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-25.5F, -21.0F, -1.7F, 0.0F, 1.5708F, 0.0F));

		ModelPartData cube_r6 = sign.addChild("cube_r6", ModelPartBuilder.create().uv(0, 78).cuboid(-26.0F, 0.0F, -1.0F, 48.0F, 10.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(25.5F, -21.0F, -1.7F, 0.0F, 1.5708F, 0.0F));
		...
		.uv(128, 150).cuboid(-8.0F, 8.0F, 8.0F, 16.0F, 16.0F, 16.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData beacon = bone.addChild("beacon", ModelPartBuilder.create().uv(100, 54).cuboid(-8.0F, -15.0F, -8.0F, 16.0F, 16.0F, 16.0F, new Dilation(0.0F))
		.uv(229, 96).cuboid(-6.0F, -1.0F, -6.0F, 12.0F, 2.0F, 12.0F, new Dilation(0.0F))
		.uv(96, 246).cuboid(-5.0F, -11.0F, -5.0F, 10.0F, 10.0F, 10.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -27.0F, 0.0F));
