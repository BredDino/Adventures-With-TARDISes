...
import net.awt.client.models.monitors.TrustableMonitorModel;
...
public class AWTMonitorRenderer<T extends AWTMonitorBlockEntity> implements BlockEntityRenderer<T> {

    public static final Identifier MONITOR_TEXTURE = new Identifier(AdventuresWithTARDISes.MOD_ID,
            "textures/blockentities/monitors/trustable_monitor.png");
    //public static final Identifier EMISSIVE_MONITOR_TEXTURE = new Identifier(AdventuresWithTARDISes.MOD_ID,
      //      "textures/blockentities/monitors/trustable_monitor_emission.png");
    private final TextRenderer textRenderer = MinecraftClient.getInstance().textRenderer;
    private final TrustableMonitorModel trustableMonitorModel;

    public AWTMonitorRenderer(BlockEntityRendererFactory.Context ctx) {
        this.trustableMonitorModel = new TrustableMonitorModel(TrustableMonitorModel.getTexturedModelData().createModel());
    }
    ...
    @Override
    public void render(AWTMonitorBlockEntity entity, float tickDelta, MatrixStack matrices,
