...
public class AWTMonitorBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public AWTMonitorBlock(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new AWTMonitorBlockEntity(pos, state);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand,
        ...
        if (blockEntity instanceof AWTMonitorBlockEntity monitorBlockEntity)
